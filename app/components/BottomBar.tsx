...
const BottomBar: React.FC<BottomBarProps> = ({ menuItems }) => {
    return (
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2">
            <div className="flex items-center space-x-3 px-5 py-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-3xl border border-gray-200 dark:border-gray-600/50 shadow-2xl gap-2 transition-colors duration-300">
                {menuItems.map((item) => (
                    <div
                        key={item.id}
                ...
                <div className='px-[0.5px] bg-gray-300 dark:bg-gray-600 h-10'></div>
